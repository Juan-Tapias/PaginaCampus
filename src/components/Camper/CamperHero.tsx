...
export default function CamperHero() {
  ...
  return (
    <section id="sé-un-camper" className="relative w-full flex items-start lg:h-screen overflow-hidden bg-transparent pt-0">
      
      <div className="container relative z-40 mx-auto px-6 lg:px-12 flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-0 -mt-10 lg:-mt-32">
        ...
        <div className="w-full lg:w-[55%] flex flex-col items-center lg:items-start text-center lg:text-left lg:pl-10">
          ...
          >
            <button className="bg-[#5E39DA] text-white w-full sm:w-auto px-8 h-[50px] rounded-[4px] font-roboto-mono text-[15px] hover:bg-[#7446F2] transition-colors">
              {hero.primary_cta}
            </button>
            <a 
              ...
              className="bg-transparent border border-gray-500 text-gray-300 w-full sm:w-auto px-6 h-[50px] rounded-[4px] font-roboto-mono text-[15px] hover:border-gray-300 hover:text-white transition-colors flex items-center justify-center gap-3"
            >
