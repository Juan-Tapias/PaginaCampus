...
export default function CamperHero() {
  ...
  return (
    <section id="sé-un-camper" className="relative w-full flex items-center min-h-[100vh] lg:h-screen overflow-hidden bg-transparent pt-20 pb-20 lg:pt-0 lg:pb-0">
      
      <div className="container relative z-40 mx-auto px-6 lg:px-12 flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-0 h-full lg:-mt-60">
