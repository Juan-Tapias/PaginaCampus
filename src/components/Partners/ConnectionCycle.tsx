...
export default function ConnectionCycle() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 flex w-full flex-col overflow-hidden lg:flex-row lg:items-center lg:gap-20">
        <motion.div
          initial={{ opacity: 0, x: -30 }}
          whileInView={{ opacity: 0.9, x: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className="relative ml-20 mt-[150px] hidden flex-col pl-6 lg:flex lg:w-[700px] lg:pl-12 xl:pl-24 h-fit min-h-[700px]"
        >
          <div className="h-full w-full">
            <TypewriterContent
              ...
              align="left"
              scrolling={false}
              className="font-roboto-mono h-full text-[16px] tracking-normal text-left"
            />
          </div>
        ...
        <div className="flex flex-1 flex-col overflow-hidden px-6 lg:px-12">
          <header className="mb-16 px-6 text-center lg:px-12 xl:px-24">
            <h2 className="font-poppins text-[32px] font-semibold text-white sm:text-[40px]">
          ...
          <div className="relative mt-10 ml-[150px] w-full overflow-hidden pt-40 lg:w-full">
            <div className="absolute left-0 right-0 top-[248px] h-px bg-gradient-to-r from-[#54C6AA]/30 via-[#2893E8]/30 to-transparent" />

            <div className="relative">
              <motion.div
                animate={{ x: activeStep === 0 ? '0px' : `calc(50% - 120px - ${activeStep * STEP_WIDTH}px)` }}
          ...
          {/* Navigation Dots */}
          <div className="mt-20 flex justify-center gap-3 pr-6 lg:justify-end lg:pr-12 xl:pr-24">
